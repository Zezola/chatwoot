...
ActiveRecord::Schema[7.1].define(version: 2026_06_10_000100) do
  ...
  create_table "Virti_UsuarioACL", primary_key: "Id", id: :serial, force: :cascade do |t|
    ...
    t.index ["IdUsuario"], name: "Virti_UsuarioACL_IdUsuario_key", unique: true
  end
  ...
  create_table "virti_acl_models", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.string "name", null: false
    t.text "description"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "name"], name: "index_virti_acl_models_on_account_id_and_name", unique: true
    t.index ["account_id"], name: "index_virti_acl_models_on_account_id"
  end

  create_table "virti_acl_user_models", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "user_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "user_id"], name: "index_virti_acl_user_models_on_account_id_and_user_id", unique: true
    t.index ["account_id"], name: "index_virti_acl_user_models_on_account_id"
    t.index ["model_id"], name: "index_virti_acl_user_models_on_model_id"
  ...
  add_foreign_key "virti_acl_models", "accounts"
  add_foreign_key "virti_acl_models", "users", column: "created_by_id"
  add_foreign_key "virti_acl_models", "users", column: "updated_by_id"
  add_foreign_key "virti_acl_user_models", "accounts"
  add_foreign_key "virti_acl_user_models", "users"
